...
public class Commonactions extends Base {
	...
	public static boolean mouseoverExample(WebDriver driver, WebElement ele) {
		boolean flag = false;
		try {
			...
			// Assert.assertEquals(s,"SpiceClub Members");
	...
	/**
	 * Author : himanshu Description : Highlight focused WebElement
	 *
	 * @param elmt
	 * @param driver
	 * @return
	...
	/**
	 * Author : himanshu Description : Clicking the invisible(Hidden)
	 * Elements
	 *
	 * @param driver
	 * @param element
	...
	/**
	 * Author : himanshu Description : Waiting for an Element until it is
	 * visible
	 *
	 * @param driver
	 * @param element
	...
	/**
	 * Author : himanshu Description : Date picker method
	 *
	 * @param driver
	 * @param date
	 * @return
